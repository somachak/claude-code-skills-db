...
description: "Security-focused differential review of code changes (PRs, commits, diffs). Adapts analysis depth to codebase size, uses git history for context, calculates blast radius, checks test coverage, and generates comprehensive markdown reports. Automatically detects security regressions. Risk-first: focuses on auth, crypto, value transfer, external calls."
---
