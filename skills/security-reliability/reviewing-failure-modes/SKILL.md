...
Use it for back-end, platform, full-stack workflows in the `security-reliability` category.

## What This Skill Does

Reviews how systems fail under dependency outages, partial writes, retries, and degraded states. Use when services coordinate remote calls, queues, or critical transactions.
...
- Center on what users experience and what operators can recover quickly.
...
- `examples/degradation-patterns.md`
