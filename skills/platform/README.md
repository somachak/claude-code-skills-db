...
CI/CD, containers, infrastructure as code, monorepos, release workflows, and developer experience.

## Included skills

- [`docker-optimization/`](./docker-optimization/) — Optimizes Dockerfiles and docker-compose configurations for image size, build speed, layer caching, and security hardening.
...
- [`shipping-containerized-services/`](./shipping-containerized-services/) — Packages services for containers with lean images, safe defaults, environment strategy, and deployment readiness checks.
